...
$query = mysqli_query($con, "SELECT documents.tracking_number,documents.document_id, documents.document_name
							...
							INNER JOIN documents ON documents_history.document_id = documents.document_id WHERE (dochist_type = 1 or dochist_type = 4) and department_id = $dept_id and dochist_active = 1");
